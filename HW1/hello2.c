...
double *calculateCentroids(int **arr, struct vector *head_vec, int *counters, int D, int N, int i);
...
double *calculateCentroids(int **array, struct vector *head_vec, int *counters, int D, int N, int lineIndex)
{
    struct vector *curr_vec = head_vec;
    struct cord *curr_cord = head_vec->cords;
...
int updateCentroids(double **centroids, int **array, struct vector *head_vec, int *counters, int K, int D, int N)
{
    ...
    {
        newCentroid = calculateCentroids(array, head_vec, counters, D, N, i);
